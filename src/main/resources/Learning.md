...
**2.Adding the database configurations\
Two ways:**

**1\. Auto-configuration **- you use an application properties file\
...
**2\. Manual** - adding a configuration class using @Configuration annotation
...
✅ Compatible dependency versions\✅ Maven plugin configuration\✅ Java compiler settings\✅ Spring Boot packaging support\✅ Default configuration for building and running your application
